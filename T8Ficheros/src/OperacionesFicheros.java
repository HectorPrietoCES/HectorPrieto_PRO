...
public class OperacionesFicheros {
    ...
    public void creacionFichero() {
        ...
        File fileFinal = new File("C:\\Users\\Usuario DAM1\\Desktop\\Ficheros\\a.txt");
        File fileCarpeta = new File("C:\\Users\\Usuario DAM1\\Desktop\\Ficheros\\aaaa.txt");
        File ficheroProyecto = new File("C:\\Users\\Usuario DAM1\\Desktop\\Ficheros\\aaaaa.txt");
    ...
    public void escrituraBase(){
        String ejemplo= "esto es un ejemplo de escritura base para comprobar que esta todo OK";

        File file = new File("src/Ficheros/escritura.txt");
